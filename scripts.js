...
function getInput() {
    ...
    if(input.value.length<=5){
        input.value = word;
        displayWord(word, input.value.length);
    }else{
        word=maxWord;
        input.value = maxWord;
    }
...
function checkWord(){
    ...
    for(var i=0; i<words.length; i++){
        if(input.value == words[i].toUpperCase()){
            isWordValid=true;
        }
    }
    ...
    for(var i=0; i<5; i++){
        ...
        if(result==1){
            letter.style.backgroundColor = "rgb(159, 143, 0)";
            letter.style.borderColor = "rgb(159, 143, 0)";
        }
        if(result==2){
            letter.style.backgroundColor = "rgb(3, 154, 0)";
            letter.style.borderColor = "rgb(3, 154, 0)";
            match++;
        }
    }
    if(match==5){
